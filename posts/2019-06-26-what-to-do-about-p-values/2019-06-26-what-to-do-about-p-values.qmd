...
# Read in data
keith = readr::read_csv(file = "~/Documents/github/rustic-penguin/data/keith-gpa.csv")
...
```{r, message=FALSE, fig.align='center', fig.cap="Regression line fitted using the empirical data (black) and uncertainty in its location based on the location of 1000 bootstrapped lines", eval=FALSE}
library(educate)
...
```{r, message=FALSE, fig.align='center', fig.cap="Plot of the model residuals versus the fitted values. The blue lines show 1000 bootstrapped loess smoothers for the data. The line at y=0 is also displayed (black).", eval=FALSE}
broom::augment(lm.1) %>%
